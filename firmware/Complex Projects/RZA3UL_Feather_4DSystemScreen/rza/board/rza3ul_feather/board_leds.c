...
/******************************************************************************************************************//**
 * @addtogroup BOARD_RZA3UL_FEATHER_LEDS
 *
 * @{
 *********************************************************************************************************************/
...
#if defined(BOARD_RZA3UL_FEATHER)
...
{
    (uint16_t) BSP_IO_PORT_16_PIN_00,  ///< LED
};
...
#endif                                 /* BOARD_RZA3UL_FEATHER */

/** @} (end addtogroup BOARD_RZA3UL_FEATHER_LEDS) */
